...
const PRODUCTS: Product[] = [
  ...
  { slug: "carepatch", navName: "carePATCH\u2122", logo: "/images/tiger-assets/carepatch.png", logoSize: 41236, packaging: null, packagingSize: 0, location: null, locationSize: 0, division: "wound" },
  ...
  { slug: "expanders", navName: "Breast Tissue Expanders", logo: "/images/tiger-assets/expanders.png", logoSize: 317930, packaging: null, packagingSize: 0, location: null, locationSize: 0, division: "aesthetics" },
...
function ImageCell({ src, alt, label, size, slug, onPreview }: {
  ...
  return (
    <div className="relative aspect-[3/2] flex items-center justify-center px-2 text-center" style={{ background: "rgba(35,16,16,0.06)" }}>
